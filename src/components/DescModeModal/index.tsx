			...
			<Wrapper2>
				...
				<SearchBox>
					...
					* Через 5 минут можно перезайти и проверить айди своей клетки в
					...
					<b>~~Сайдбар~~</b>
					<br />
					* стрелочки в центр - приближение карты / отдаление карты
					<br />
					* кубики с плюсиком - селект областей для покупки
					<br />
					* лупа - TonCells Viewer (таблица с поиском по ней, можно отследить
					любую инфу по нашим нфт)
					<br />
					* три полоски - разные виды карты (1 - стандарт / 2 - все свободные
					области зеленым / 3 - все отминчиные зеленым)
					<br />
					* "i" - эта модалка
					<br />
					* вопрос - ссылка на техподдержку
					<br />
					<br />
					<b>~~Важно~~</b>
					<br />
